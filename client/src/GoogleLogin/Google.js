...
const client = "822679158214-b1j8dn9b5k18g1pvuo8sctstod8bi6qa.apps.googleusercontent.com"
const Google = (props) => {

    const onSuccess = (res) => {
        props.auth("", res.profileObj.email, res.accessToken, res.profileObj.name, res.profileObj.imageUrl, "", "", "", "", "","", "Google")
            ...
            <>
                <link rel="stylesheet" type="text/css" href="//fonts.googleapis.com/css?family=Open+Sans" />
                    ...
                    <div className={classes.googleiconwrapper}>
                        <img style = {{marginLeft : props.margin}} className={classes.googleicon} src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg" alt = "Google"/>
                    </div>
                    <p onClick = {renderProps.onClick} className={classes.btntext}><b>Sign in with google</b></p>
                    </div>
            </>
    )}  />
    )
