...
search = (event) => {
  console.log("Yeas")
  console.log(this.state)
  if(this.state.headline === "" || this.state.location === "" || this.state.position === "") {
    return
  }
  console.log("Yeah")
  let data = {
    ...
    <fieldset>
      ...
      <div className={classes.innerform}>
        <div className={classes.inputfield}>
          ...
          <input onChange = {(e) => {this.headlineHandler(e)}}  autoComplete = "off"  id="search" type="text" placeholder="Who are You Looking For ? "/>
      ...
      <div className={classes.suggestionwrap}>
       {/* <span  className = {classes.suggestionspan}><input autoComplete = "off"  className = {classes.skills} id = "search" type = "text" placeholder = "Skills" /></span>  */}
        ...
        <span className = {classes.suggestionspan}><select onChange = {(e) => {this.positionHandler(e)}} name = "type" id = "type" className = {classes.skills}>
